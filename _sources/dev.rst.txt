...
NOTE: Most of the unit-tests are generated by an AI. I have let it create the tests by itself and have not really checked them (except for the fact that they actually run). That said, I have caught a few bugs in the package using these auto-generated tests and I found them quite useful.
